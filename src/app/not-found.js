...
export default function NotFoundPage() {
  return (
    <main className="h-full w-full flex items-center justify-center py-4 px-4 bg-white dark:bg-background">
      <div className="container mx-auto">
        <div className="flex justify-center">
          <div className="w-full sm:w-10/12 md:w-8/12 text-center">
            {/* 404 Hero Section */}
            <div className="relative py-12">
              <h1 className="text-center text-black dark:text-white text-8xl sm:text-9xl font-bold">
                404
              </h1>
            </div>
            ...
            <div className="mt-[-30px]">
              <h3 className="text-xl text-black dark:text-white sm:text-2xl font-bold mb-3">
                Look like you're lost
              </h3>
              <p className="mb-4 text-black dark:text-muted-foreground text-sm sm:text-base">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                {demoLinks.map((link) => (
                  <Link
                    href={link.href}
                    key={link.title}
                    className="group relative p-3 border border-gray-200 dark:border-white/10 rounded-lg hover:border-green-500 dark:hover:border-green-500 transition-all hover:shadow-lg bg-white dark:bg-card"
                  >
                    <div className="flex flex-col items-center text-center gap-2">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <div className="text-sm font-semibold text-black dark:text-white flex items-center justify-center gap-2">
                          {link.title}
