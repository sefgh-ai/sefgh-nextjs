  ...
  return (
    <div
      ...
      <div
        ...
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col glass-premium rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-premium">
          {children}
        </div>
      </div>
    </div>
