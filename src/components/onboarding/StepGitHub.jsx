        ...
        <div className="flex-1">
          <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-4">
            ...
            <p className="text-[#8b949e] text-xs mt-1">
              This helps us show you personalized recommendations based on your activity
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-6">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <ul className="mt-2 space-y-1 text-[#8b949e] text-sm">
              <li className="flex items-center gap-2">
                <div className="h-1 w-1 rounded-full bg-[#238636]"></div>
                Show your starred repositories
              </li>
              <li className="flex items-center gap-2">
                <div className="h-1 w-1 rounded-full bg-[#238636]"></div>
          ...
          <div className="flex gap-2">
            <div className="flex-1">
              <Input
                ...
                className="bg-[#0d1117] border-[#30363d] text-white placeholder-[#8b949e] focus:border-[#58a6ff]"
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                    handleConnect()
                  }
