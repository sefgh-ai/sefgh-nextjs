  ...
  return (
    <div className="sticky top-0 z-50 border-b border-white/10 backdrop-blur-sm">
      <div className="flex h-14 items-center px-4 gap-3">
        ...
        {/* Unified Filters Navigation Menu */}
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              <NavigationMenuTrigger className="h-8 rounded-xl glass-premium hover:glow-border-slate transition-smooth shadow-soft data-[state=open]:glow-border-blue">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        className="w-full h-8 px-2 text-sm rounded-lg glass-premium border border-white/10 bg-transparent focus:outline-none focus:ring-1 focus:ring-blue-500/50"
                      >
