      ...
      <form onSubmit={handleSearch}>
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 text-lg rounded-2xl glass-premium border-white/10 focus:outline-none focus:glow-border-blue disabled:opacity-50 transition-smooth shadow-soft hover:shadow-soft-lg"
          />
          {searchQuery && (
            <button
              type="button"
