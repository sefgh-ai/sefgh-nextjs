/**
 * Platform data for download cards
 */
export const platformData = {
  macOS: {
    name: 'macOS',
    icon: (
      <svg className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 text-gray-900 dark:text-white transition-transform duration-500" viewBox="0 0 24 24" fill="currentColor">
        <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
      </svg>
    ),
    gradient: 'from-soft-cyan via-soft-violet to-soft-blue',
    hoverGradient: 'from-soft-cyan to-soft-violet',
    iconBg: 'from-soft-cyan/10 to-soft-violet/10',
    downloads: [
  ...
  Windows: {
    name: 'Windows',
    icon: (
      <svg className="relative w-24 h-24 text-blue-600 dark:text-blue-400 transition-transform duration-500" viewBox="0 0 24 24" fill="currentColor">
        <path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801" />
      </svg>
    ),
    gradient: 'from-soft-cyan via-soft-violet to-soft-blue',
    hoverGradient: 'from-soft-cyan to-soft-blue',
    iconBg: 'from-soft-cyan/10 to-soft-blue/10',
    downloads: [
  ...
  Linux: {
    name: 'Linux',
    icon: (
      <svg className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 text-yellow-500 dark:text-yellow-400 transition-transform duration-500" viewBox="0 0 24 24" fill="currentColor">
    ...
    gradient: 'from-soft-violet via-soft-blue to-soft-cyan',
    hoverGradient: 'from-soft-violet to-soft-cyan',
    iconBg: 'from-soft-violet/10 to-soft-cyan/10',
    downloads: [
      { label: 'Download', href: '#' }
    ]
  },
  iOS: {
    ...
    gradient: 'from-soft-cyan to-soft-violet',
    hoverGradient: 'from-soft-cyan to-soft-violet',
    iconBg: 'from-soft-cyan/10 to-soft-violet/10',
    downloads: [
      { label: 'Download from App Store', href: '#' }
    ]
  },
  Android: {
    name: 'Android',
    icon: (
      <svg className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 text-green-500 dark:text-green-400 transition-transform duration-500" viewBox="0 0 24 24" fill="currentColor">
    ...
    hoverGradient: 'from-soft-violet to-soft-blue',
    iconBg: 'from-soft-violet/10 to-soft-blue/10',
    downloads: [
      { label: 'Download from Play Store', href: '#' }
    ]
  }
}
